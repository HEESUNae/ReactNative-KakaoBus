...
const BusInfo = ({ isBookmarked, num, directionDescription, numColor, processedNextBusInfos }) => {
  return (
    <View style={{ flexDirection: 'row', height: 75, backgroundColor: 'white' }}>
      <View style={{ flex: 0.85, flexDirection: 'row', alignItems: 'center' }}>
        <BookmarkButton size={20} isBookmarked={isBookmarked} onPress={() => {}} style={{ paddingHorizontal: 10 }} />
        <View style={{ flex: 1 }}>
